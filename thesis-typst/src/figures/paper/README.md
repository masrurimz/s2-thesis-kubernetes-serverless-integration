...
| fig02-paired-p99 | Per-pair p99, S3 against S4, definitive paired n = 5 | `2026-07-14_clarknet-tuned-paired-n5` | S3 235,6 / 192,2 / 151,4 / 164,0 / 199,2 ms; S4 101,4 / 104,9 / 100,5 / 155,7 / 167,4 ms; SLO line at 200 ms; p = 0,0312, the 1/32 design floor |
...
| fig07-replication-forest | H2 forest plot, mean difference with 95 percent CI across batches | definitive and replication bundles | Definitive −62,5 ms [−100,9; −26,2], p = 0,0312; RUN1 −4,0 [−57,8; +66,1], p = 0,436; RUN2 −58,0 [−161,5; −2,8], p = 0,062; RUN3 −52,5 [−102,6; −11,8], p = 0,032 |
