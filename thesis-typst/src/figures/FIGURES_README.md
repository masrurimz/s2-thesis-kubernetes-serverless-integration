...
| fig04_4 | `fig-node-provisioning()` | Node CPU% timeline + provisioning events | `2026-07-14_clarknet-tuned-paired-n5/s3-hybrid-reactive_run1/{node_utilization,provision_events}.json` | node_created at t≈394 s, t≈669 s (green); scale_down at t≈763 s, t≈1230 s (red) |
...
| fig04_6 | `figures/fig04_6_replication_batches.png` (matplotlib) | H2 effect-size forest across batches | definitive + `2026-08-08_paired-h2_{195150,233726}/paired_analysis.json` + `2026-08-09_clarknet-replay_032257/report.md` | d=−1.26 (p=0.030), d=−0.050 (p=0.436), d=−0.505 (p=0.062), d=−1.300 (MW p=0.032) |
