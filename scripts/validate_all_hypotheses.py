...
class HypothesisValidator:
    ...
    def validate_h1_hybrid_vs_pure(self) -> HypothesisResult:
        ...
        s4_vs_s1 = {
            "p50_latency_improvement": ((s1_metrics.p50_latency_ms - s4_metrics.p50_latency_ms) / s1_metrics.p50_latency_ms) * 100,
            "p95_latency_improvement": ((s1_metrics.p95_latency_ms - s4_metrics.p95_latency_ms) / s1_metrics.p95_latency_ms) * 100,
            "error_rate_improvement": ((s1_metrics.error_rate_percent - s4_metrics.error_rate_percent) / s1_metrics.error_rate_percent) * 100,
            "throughput_improvement": ((s4_metrics.throughput_rps - s1_metrics.throughput_rps) / s1_metrics.throughput_rps) * 100,
        }
        
        s4_vs_s2 = {
            "p50_latency_improvement": ((s2_metrics.p50_latency_ms - s4_metrics.p50_latency_ms) / s2_metrics.p50_latency_ms) * 100,
            "p95_latency_improvement": ((s2_metrics.p95_latency_ms - s4_metrics.p95_latency_ms) / s2_metrics.p95_latency_ms) * 100,
            "error_rate_improvement": ((s2_metrics.error_rate_percent - s4_metrics.error_rate_percent) / max(s2_metrics.error_rate_percent, 0.01)) * 100,
            "throughput_improvement": ((s4_metrics.throughput_rps - s2_metrics.throughput_rps) / s2_metrics.throughput_rps) * 100,
        }
    ...
    def validate_h2_predictive_vs_reactive(self) -> HypothesisResult:
        ...
        # Calculate improvements
        s4_vs_s3 = {
            "p50_latency_improvement": ((s3_metrics.p50_latency_ms - s4_metrics.p50_latency_ms) / s3_metrics.p50_latency_ms) * 100,
            "p95_latency_improvement": ((s3_metrics.p95_latency_ms - s4_metrics.p95_latency_ms) / s3_metrics.p95_latency_ms) * 100,
            "error_rate_improvement": ((s3_metrics.error_rate_percent - s4_metrics.error_rate_percent) / s3_metrics.error_rate_percent) * 100,
            "throughput_improvement": ((s4_metrics.throughput_rps - s3_metrics.throughput_rps) / s3_metrics.throughput_rps) * 100,
        }
    ...
    def run_all_validations(self) -> Dict:
        ...
        logger.info("=" * 70)
        logger.info(f"OVERALL: {'✅ ALL HYPOTHESES VALIDATED' if all_proven else '⚠️ SOME HYPOTHESES NEED FURTHER VALIDATION'}")
        logger.info("=" * 70)
