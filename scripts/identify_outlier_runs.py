...
def analyze_outliers():
    ...
    for scenario_name, runs in scenarios.items():
        ...
        print(f"   throughput: mean={throughput_mean:.1f}RPS, median={throughput_median:.1f}RPS, stdev={throughput_stdev:.1f}RPS")
...
""")
    ...
    outlier_file = Path(__file__).parent.parent / "results/experiments/phase-b/2026-02-12_replicated-20runs/raw/outliers.json"
