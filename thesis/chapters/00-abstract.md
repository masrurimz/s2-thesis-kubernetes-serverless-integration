...
Hasil paired menunjukkan S4 (hybrid-predictive) mencapai mean p99 126.0 ms dibanding S3 188.5 ms (selisih −62.5 ms, 95% CI [−100.9, −26.2], Cohen's d = −1.26, p = 0.0312, lantai desain 1/32 pada n = 5 karena kelima pasangan jatuh searah). Pelanggaran SLO rata-rata turun dari 656 menjadi 130 per run (−80.2%), sementara biaya proyeksi bulanan S3 dan S4 identik, USD 163. Diagnostic n=1 mencatat S1/S2/S3/S4 masing-masing 2,421.3/77.7/98.8/118.2 ms dan biaya USD 132/394/147/142. GRU memperoleh RMSE 4.75% pada data sintetis (6.01% sebelum HPO) dan 17.78% pada ClarkNet nyata. Hasil sekunder dilaporkan deskriptif setelah koreksi multiplisitas.
