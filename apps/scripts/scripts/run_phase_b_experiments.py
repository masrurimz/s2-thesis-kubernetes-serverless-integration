...
SCRIPT_DIR = Path(__file__).resolve().parent  # apps/scripts/scripts/
PROJECT_ROOT = SCRIPT_DIR.parent.parent.parent  # repo root
...
def main():
    ...
    if args.phase in ("analysis", "full") and not args.skip_cost:
        ...
        try:
            from scripts.cost_analyzer import run_experiment_analysis
