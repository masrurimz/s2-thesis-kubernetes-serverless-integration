...
**Date:** 2026-07-07T11:59:39.841687
**Git:** f7ee6ad
...
|----------|---|----------|----------|----------|--------|-----|----------------|----------|------------|
| s1-k8s-only | 1 | 54.8 | 57.0 | 60.3 | 0.000 | 73.2 | 0 | 0 | 0 |
| s2-serverless-only | 1 | 0.6 | 9809.5 | 60000.4 | 0.000 | 52.2 | 5158 | 0 | 0 |
| s3-hybrid-reactive | 1 | 54.8 | 58.2 | 78.0 | 0.000 | 73.2 | 2 | 0 | 0 |
| s4-hybrid-predictive | 1 | 54.8 | 57.1 | 62.5 | 0.000 | 73.2 | 0 | 0 | 0 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 60.27 (n=1) |
| Comparison mean | 60000.40 (n=1) |
| Difference | +59940.13 (+99445.6%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 1.0 |
| Mann-Whitney p | 1.0000 |
| 95% CI | [+59940.13, +59940.13] |
| Cohen's d | nan (large) |
...
|--------|-------|
| Baseline mean | 60.27 (n=1) |
| Comparison mean | 77.97 (n=1) |
| Difference | +17.69 (+29.4%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 1.0 |
| Mann-Whitney p | 1.0000 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 60000.40 (n=1) |
| Comparison mean | 77.97 (n=1) |
| Difference | -59922.43 (-99.9%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
| Mann-Whitney p | 1.0000 |
| 95% CI | [-59922.43, -59922.43] |
| Cohen's d | nan (large) |
| Verdict | ⚠️ Not significant |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 77.97 (n=1) |
| Comparison mean | 62.50 (n=1) |
| Difference | -15.47 (-19.8%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
| Mann-Whitney p | 1.0000 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 2.00 (n=1) |
| Comparison mean | 0.00 (n=1) |
| Difference | -2.00 (-100.0%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
| Mann-Whitney p | 1.0000 |
