...
**Date:** 2026-07-08T09:28:50.574625
**Git:** 0bcce7b
...
|----------|---|----------|----------|----------|--------|-----|----------------|----------|------------|
| s1-k8s-only | 1 | 63.8 | 74.8 | 97.1 | 0.000 | 73.2 | 4 | 0 | 0 |
| s2-serverless-only | 1 | 65.1 | 75.4 | 77.9 | 0.000 | 73.2 | 14 | 0 | 0 |
| s3-hybrid-reactive | 1 | 64.8 | 182.2 | 426.3 | 0.000 | 73.2 | 3874 | 0 | 0 |
| s4-hybrid-predictive | 1 | 64.8 | 146.9 | 308.3 | 0.000 | 73.2 | 2229 | 0 | 0 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 97.08 (n=1) |
| Comparison mean | 77.92 (n=1) |
| Difference | -19.17 (-19.7%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
...
|--------|-------|
| Baseline mean | 97.08 (n=1) |
| Comparison mean | 426.30 (n=1) |
| Difference | +329.22 (+339.1%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 1.0 |
| Mann-Whitney p | 1.0000 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 77.92 (n=1) |
| Comparison mean | 426.30 (n=1) |
| Difference | +348.38 (+447.1%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 1.0 |
| Mann-Whitney p | 1.0000 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 426.30 (n=1) |
| Comparison mean | 308.35 (n=1) |
| Difference | -117.95 (-27.7%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
| Mann-Whitney p | 1.0000 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 3874.00 (n=1) |
| Comparison mean | 2229.00 (n=1) |
| Difference | -1645.00 (-42.5%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
| Mann-Whitney p | 1.0000 |
| 95% CI | [-1645.00, -1645.00] |
| Cohen's d | nan (large) |
| Verdict | ⚠️ Not significant |
