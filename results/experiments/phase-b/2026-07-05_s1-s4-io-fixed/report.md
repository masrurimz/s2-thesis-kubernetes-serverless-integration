...
**Date:** 2026-07-06T21:45:42.856545
**Git:** 1951e09
...
|----------|---|----------|----------|----------|--------|-----|----------------|----------|------------|
| s1-k8s-only | 1 | 63.8 | 78.4 | 78.4 | 0.000 | 73.2 | 58 | 0 | 0 |
| s2-serverless-only | 1 | 0.7 | 1.1 | 1.1 | 0.000 | 73.2 | 2 | 0 | 0 |
| s3-hybrid-reactive | 1 | 65.1 | 744.9 | 744.9 | 0.000 | 73.1 | 9160 | 0 | 0 |
| s4-hybrid-predictive | 1 | 65.1 | 182.9 | 182.9 | 0.000 | 73.2 | 3556 | 0 | 0 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 78.43 (n=1) |
| Comparison mean | 1.06 (n=1) |
| Difference | -77.37 (-98.6%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
...
|--------|-------|
| Baseline mean | 78.43 (n=1) |
| Comparison mean | 744.86 (n=1) |
| Difference | +666.43 (+849.7%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 1.0 |
| Mann-Whitney p | 1.0000 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 744.86 (n=1) |
| Comparison mean | 182.94 (n=1) |
| Difference | -561.92 (-75.4%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
| Mann-Whitney p | 1.0000 |
...
| Metric | Value |
|--------|-------|
| Baseline mean | 9160.00 (n=1) |
| Comparison mean | 3556.00 (n=1) |
| Difference | -5604.00 (-61.2%) |
| Welch t-stat | nan |
| Welch p-value | nan |
| Mann-Whitney U | 0.0 |
| Mann-Whitney p | 1.0000 |
| 95% CI | [-5604.00, -5604.00] |
| Cohen's d | nan (large) |
| Verdict | ⚠️ Not significant |
