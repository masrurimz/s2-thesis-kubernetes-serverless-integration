    ...
    def log_decision(self, decision: Dict) -> bool:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                logger.debug(
                    "Decision logged", type=decision_type, timestamp=timestamp, weights_changed=weights_changed
                )
                return True
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                for row in cursor.fetchall():
                    ...
                    # Parse JSON fields
                    for field in ["current_stats", "prediction_data", "previous_weights", "target_weights"]:
                        if decision[field]:
                            try:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                if stats["total_decisions"] > 0:
                    stats["weight_change_rate"] = round((stats["weight_changes"] / stats["total_decisions"]) * 100, 1)
    ...
    def cleanup_old_decisions(self, keep_days: int = 7) -> int:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                logger.info("Old decisions cleaned up", deleted=deleted_count, kept_days=keep_days)
