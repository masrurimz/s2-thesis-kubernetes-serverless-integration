...
class TestExperimentLogger:
    ...
    def test_start_run(self, logger):
        ...
        run_id = logger.start_run(scenario="s4-hybrid-predictive", workload="steady", dataset="clarknet")
    ...
    def test_start_run_with_config(self, logger):
        ...
        run_id = logger.start_run(scenario="s1-k8s-only", workload="spike", config={"duration": 300, "rps": 1000})
    ...
    def test_log_metrics(self, logger):
        ...
        logger.log_metrics(run_id, {"p50_latency": 25.5, "p99_latency": 150.0, "error_rate": 0.01})
    ...
    def test_get_run(self, logger):
        ...
        run_id = logger.start_run(scenario="s3-hybrid-reactive", workload="steady", dataset="clarknet")
...
class TestExperimentLoggerCheckpoints:
    ...
    def test_save_checkpoint(self, logger):
        ...
        checkpoint_data = {"weights": {"k3s": 75, "knative": 25}, "metrics": {"p50": 25, "p99": 100}}
